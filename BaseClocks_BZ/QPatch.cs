...
namespace BaseClocks
{
    ...
    internal class BaseClockBuildable : Buildable
    {
        ...
        private RecipeData m_TechData;
        private string m_IconName;

        public BaseClockBuildable(string classId, string displayName, string description, string iconName, GameObject prefab, RecipeData techData)
